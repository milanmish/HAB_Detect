...
def _abs(x: _atypes.TensorFuzzingAnnotation[TV_Abs_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Abs_T]:
...
def _abs_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Abs_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Abs_T]:
...
def accumulate_nv2_eager_fallback(inputs: List[_atypes.TensorFuzzingAnnotation[TV_AccumulateNV2_T]], shape, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_AccumulateNV2_T]:
  if not isinstance(inputs, (list, tuple)):
    raise TypeError(
        "Expected list for 'inputs' argument to "
        "'accumulate_nv2' Op, not %r." % inputs)
...
def acos(x: _atypes.TensorFuzzingAnnotation[TV_Acos_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Acos_T]:
...
def acos_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Acos_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Acos_T]:
...
def acosh(x: _atypes.TensorFuzzingAnnotation[TV_Acosh_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Acosh_T]:
...
def acosh_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Acosh_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Acosh_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, _dtypes.complex64, _dtypes.complex128, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def add(x: _atypes.TensorFuzzingAnnotation[TV_Add_T], y: _atypes.TensorFuzzingAnnotation[TV_Add_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Add_T]:
...
def add_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Add_T], y: _atypes.TensorFuzzingAnnotation[TV_Add_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Add_T]:
...
def add_n(inputs: List[_atypes.TensorFuzzingAnnotation[TV_AddN_T]], name=None) -> _atypes.TensorFuzzingAnnotation[TV_AddN_T]:
...
def add_v2(x: _atypes.TensorFuzzingAnnotation[TV_AddV2_T], y: _atypes.TensorFuzzingAnnotation[TV_AddV2_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_AddV2_T]:
  r"""Returns x + y element-wise.
...
def add_v2_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_AddV2_T], y: _atypes.TensorFuzzingAnnotation[TV_AddV2_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_AddV2_T]:
...
def _all(input: _atypes.TensorFuzzingAnnotation[_atypes.Bool], axis: _atypes.TensorFuzzingAnnotation[TV_All_Tidx], keep_dims:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
...
def _all_eager_fallback(input: _atypes.TensorFuzzingAnnotation[_atypes.Bool], axis: _atypes.TensorFuzzingAnnotation[TV_All_Tidx], keep_dims: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
  if keep_dims is None:
    keep_dims = False
  keep_dims = _execute.make_bool(keep_dims, "keep_dims")
...
def angle(input: _atypes.TensorFuzzingAnnotation[TV_Angle_T], Tout:TV_Angle_Tout=_dtypes.float32, name=None) -> _atypes.TensorFuzzingAnnotation[TV_Angle_Tout]:
...
def angle_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_Angle_T], Tout: TV_Angle_Tout, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Angle_Tout]:
  if Tout is None:
    Tout = _dtypes.float32
  Tout = _execute.make_type(Tout, "Tout")
...
def _any_eager_fallback(input: _atypes.TensorFuzzingAnnotation[_atypes.Bool], axis: _atypes.TensorFuzzingAnnotation[TV_Any_Tidx], keep_dims: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
  if keep_dims is None:
    keep_dims = False
  keep_dims = _execute.make_bool(keep_dims, "keep_dims")
  _attr_Tidx, (axis,) = _execute.args_to_matching_eager([axis], ctx, [_dtypes.int32, _dtypes.int64, ], _dtypes.int32)
...
def approximate_equal_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_ApproximateEqual_T], y: _atypes.TensorFuzzingAnnotation[TV_ApproximateEqual_T], tolerance: float, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
  if tolerance is None:
    tolerance = 1e-05
  tolerance = _execute.make_float(tolerance, "tolerance")
...
def arg_max(input: _atypes.TensorFuzzingAnnotation[TV_ArgMax_T], dimension: _atypes.TensorFuzzingAnnotation[TV_ArgMax_Tidx], output_type:TV_ArgMax_output_type=_dtypes.int64, name=None) -> _atypes.TensorFuzzingAnnotation[TV_ArgMax_output_type]:
...
def arg_max_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_ArgMax_T], dimension: _atypes.TensorFuzzingAnnotation[TV_ArgMax_Tidx], output_type: TV_ArgMax_output_type, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_ArgMax_output_type]:
  if output_type is None:
    output_type = _dtypes.int64
  output_type = _execute.make_type(output_type, "output_type")
...
def asin(x: _atypes.TensorFuzzingAnnotation[TV_Asin_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Asin_T]:
...
def asin_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Asin_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Asin_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, _dtypes.complex64, _dtypes.complex128, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def asinh(x: _atypes.TensorFuzzingAnnotation[TV_Asinh_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Asinh_T]:
...
def asinh_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Asinh_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Asinh_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, _dtypes.complex64, _dtypes.complex128, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def atan(x: _atypes.TensorFuzzingAnnotation[TV_Atan_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Atan_T]:
...
def atan_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Atan_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Atan_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, _dtypes.complex64, _dtypes.complex128, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def atan2(y: _atypes.TensorFuzzingAnnotation[TV_Atan2_T], x: _atypes.TensorFuzzingAnnotation[TV_Atan2_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Atan2_T]:
...
def atan2_eager_fallback(y: _atypes.TensorFuzzingAnnotation[TV_Atan2_T], x: _atypes.TensorFuzzingAnnotation[TV_Atan2_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Atan2_T]:
...
def atanh(x: _atypes.TensorFuzzingAnnotation[TV_Atanh_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Atanh_T]:
...
def atanh_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Atanh_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Atanh_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, _dtypes.complex64, _dtypes.complex128, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def batch_mat_mul(x: _atypes.TensorFuzzingAnnotation[TV_BatchMatMul_T], y: _atypes.TensorFuzzingAnnotation[TV_BatchMatMul_T], adj_x:bool=False, adj_y:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[TV_BatchMatMul_T]:
...
def batch_mat_mul_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_BatchMatMul_T], y: _atypes.TensorFuzzingAnnotation[TV_BatchMatMul_T], adj_x: bool, adj_y: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_BatchMatMul_T]:
  if adj_x is None:
    adj_x = False
  adj_x = _execute.make_bool(adj_x, "adj_x")
  if adj_y is None:
...
def batch_mat_mul_v2(x: _atypes.TensorFuzzingAnnotation[TV_BatchMatMulV2_T], y: _atypes.TensorFuzzingAnnotation[TV_BatchMatMulV2_T], adj_x:bool=False, adj_y:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[TV_BatchMatMulV2_T]:
  r"""Multiplies slices of two tensors in batches.
...
def batch_mat_mul_v2_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_BatchMatMulV2_T], y: _atypes.TensorFuzzingAnnotation[TV_BatchMatMulV2_T], adj_x: bool, adj_y: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_BatchMatMulV2_T]:
  if adj_x is None:
    adj_x = False
  adj_x = _execute.make_bool(adj_x, "adj_x")
  if adj_y is None:
...
def batch_mat_mul_v3(x: _atypes.TensorFuzzingAnnotation[TV_BatchMatMulV3_Ta], y: _atypes.TensorFuzzingAnnotation[TV_BatchMatMulV3_Tb], Tout: TV_BatchMatMulV3_Tout, adj_x:bool=False, adj_y:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[TV_BatchMatMulV3_Tout]:
  r"""Multiplies slices of two tensors in batches.
...
def batch_mat_mul_v3_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_BatchMatMulV3_Ta], y: _atypes.TensorFuzzingAnnotation[TV_BatchMatMulV3_Tb], Tout: TV_BatchMatMulV3_Tout, adj_x: bool, adj_y: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_BatchMatMulV3_Tout]:
  Tout = _execute.make_type(Tout, "Tout")
  if adj_x is None:
    adj_x = False
  adj_x = _execute.make_bool(adj_x, "adj_x")
...
def betainc(a: _atypes.TensorFuzzingAnnotation[TV_Betainc_T], b: _atypes.TensorFuzzingAnnotation[TV_Betainc_T], x: _atypes.TensorFuzzingAnnotation[TV_Betainc_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Betainc_T]:
...
def betainc_eager_fallback(a: _atypes.TensorFuzzingAnnotation[TV_Betainc_T], b: _atypes.TensorFuzzingAnnotation[TV_Betainc_T], x: _atypes.TensorFuzzingAnnotation[TV_Betainc_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Betainc_T]:
...
def bincount(arr: _atypes.TensorFuzzingAnnotation[_atypes.Int32], size: _atypes.TensorFuzzingAnnotation[_atypes.Int32], weights: _atypes.TensorFuzzingAnnotation[TV_Bincount_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Bincount_T]:
...
def bincount_eager_fallback(arr: _atypes.TensorFuzzingAnnotation[_atypes.Int32], size: _atypes.TensorFuzzingAnnotation[_atypes.Int32], weights: _atypes.TensorFuzzingAnnotation[TV_Bincount_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Bincount_T]:
...
def bucketize_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_Bucketize_T], boundaries, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Int32]:
  if not isinstance(boundaries, (list, tuple)):
    raise TypeError(
        "Expected list for 'boundaries' argument to "
        "'bucketize' Op, not %r." % boundaries)
...
TV_Cast_SrcT = TypeVar("TV_Cast_SrcT", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)
TV_Cast_DstT = TypeVar("TV_Cast_DstT", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def cast(x: _atypes.TensorFuzzingAnnotation[TV_Cast_SrcT], DstT: TV_Cast_DstT, Truncate:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[TV_Cast_DstT]:
...
def cast_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Cast_SrcT], DstT: TV_Cast_DstT, Truncate: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Cast_DstT]:
  DstT = _execute.make_type(DstT, "DstT")
  if Truncate is None:
    Truncate = False
  Truncate = _execute.make_bool(Truncate, "Truncate")
...
def ceil(x: _atypes.TensorFuzzingAnnotation[TV_Ceil_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Ceil_T]:
...
def ceil_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Ceil_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Ceil_T]:
...
def complex_abs_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_ComplexAbs_T], Tout: TV_ComplexAbs_Tout, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_ComplexAbs_Tout]:
  if Tout is None:
    Tout = _dtypes.float32
  Tout = _execute.make_type(Tout, "Tout")
...
def conj(input: _atypes.TensorFuzzingAnnotation[TV_Conj_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Conj_T]:
...
def conj_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_Conj_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Conj_T]:
...
def cos(x: _atypes.TensorFuzzingAnnotation[TV_Cos_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Cos_T]:
...
def cos_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Cos_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Cos_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, _dtypes.complex64, _dtypes.complex128, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def cosh(x: _atypes.TensorFuzzingAnnotation[TV_Cosh_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Cosh_T]:
...
def cosh_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Cosh_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Cosh_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, _dtypes.complex64, _dtypes.complex128, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def cross(a: _atypes.TensorFuzzingAnnotation[TV_Cross_T], b: _atypes.TensorFuzzingAnnotation[TV_Cross_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Cross_T]:
...
def cross_eager_fallback(a: _atypes.TensorFuzzingAnnotation[TV_Cross_T], b: _atypes.TensorFuzzingAnnotation[TV_Cross_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Cross_T]:
...
def cumprod(x: _atypes.TensorFuzzingAnnotation[TV_Cumprod_T], axis: _atypes.TensorFuzzingAnnotation[TV_Cumprod_Tidx], exclusive:bool=False, reverse:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[TV_Cumprod_T]:
...
def cumprod_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Cumprod_T], axis: _atypes.TensorFuzzingAnnotation[TV_Cumprod_Tidx], exclusive: bool, reverse: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Cumprod_T]:
  if exclusive is None:
    exclusive = False
  exclusive = _execute.make_bool(exclusive, "exclusive")
  if reverse is None:
...
def cumsum(x: _atypes.TensorFuzzingAnnotation[TV_Cumsum_T], axis: _atypes.TensorFuzzingAnnotation[TV_Cumsum_Tidx], exclusive:bool=False, reverse:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[TV_Cumsum_T]:
...
def cumsum_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Cumsum_T], axis: _atypes.TensorFuzzingAnnotation[TV_Cumsum_Tidx], exclusive: bool, reverse: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Cumsum_T]:
  if exclusive is None:
    exclusive = False
  exclusive = _execute.make_bool(exclusive, "exclusive")
  if reverse is None:
...
def cumulative_logsumexp(x: _atypes.TensorFuzzingAnnotation[TV_CumulativeLogsumexp_T], axis: _atypes.TensorFuzzingAnnotation[TV_CumulativeLogsumexp_Tidx], exclusive:bool=False, reverse:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[TV_CumulativeLogsumexp_T]:
  r"""Compute the cumulative product of the tensor `x` along `axis`.
...
def dense_bincount(input: _atypes.TensorFuzzingAnnotation[TV_DenseBincount_Tidx], size: _atypes.TensorFuzzingAnnotation[TV_DenseBincount_Tidx], weights: _atypes.TensorFuzzingAnnotation[TV_DenseBincount_T], binary_output:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[TV_DenseBincount_T]:
  r"""Counts the number of occurrences of each value in an integer array.
...
def digamma(x: _atypes.TensorFuzzingAnnotation[TV_Digamma_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Digamma_T]:
...
def digamma_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Digamma_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Digamma_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def div(x: _atypes.TensorFuzzingAnnotation[TV_Div_T], y: _atypes.TensorFuzzingAnnotation[TV_Div_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Div_T]:
  r"""Returns x / y element-wise.
...
def div_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Div_T], y: _atypes.TensorFuzzingAnnotation[TV_Div_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Div_T]:
...
def div_no_nan(x: _atypes.TensorFuzzingAnnotation[TV_DivNoNan_T], y: _atypes.TensorFuzzingAnnotation[TV_DivNoNan_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_DivNoNan_T]:
...
TV_Equal_T = TypeVar("TV_Equal_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def equal(x: _atypes.TensorFuzzingAnnotation[TV_Equal_T], y: _atypes.TensorFuzzingAnnotation[TV_Equal_T], incompatible_shape_error:bool=True, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
...
def erf(x: _atypes.TensorFuzzingAnnotation[TV_Erf_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Erf_T]:
...
def erf_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Erf_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Erf_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def erfc(x: _atypes.TensorFuzzingAnnotation[TV_Erfc_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Erfc_T]:
...
def erfc_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Erfc_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Erfc_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def erfinv(x: _atypes.TensorFuzzingAnnotation[TV_Erfinv_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Erfinv_T]:
  r"""TODO: add doc.
...
def erfinv_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Erfinv_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Erfinv_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def euclidean_norm(input: _atypes.TensorFuzzingAnnotation[TV_EuclideanNorm_T], axis: _atypes.TensorFuzzingAnnotation[TV_EuclideanNorm_Tidx], keep_dims:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[TV_EuclideanNorm_T]:
...
def euclidean_norm_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_EuclideanNorm_T], axis: _atypes.TensorFuzzingAnnotation[TV_EuclideanNorm_Tidx], keep_dims: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_EuclideanNorm_T]:
  if keep_dims is None:
    keep_dims = False
  keep_dims = _execute.make_bool(keep_dims, "keep_dims")
  _attr_T, (input,) = _execute.args_to_matching_eager([input], ctx, [_dtypes.float32, _dtypes.float64, _dtypes.int32, _dtypes.uint8, _dtypes.int16, _dtypes.int8, _dtypes.complex64, _dtypes.int64, _dtypes.qint8, _dtypes.quint8, _dtypes.qint32, _dtypes.bfloat16, _dtypes.qint16, _dtypes.quint16, _dtypes.uint16, _dtypes.complex128, _dtypes.half, _dtypes.uint32, _dtypes.uint64, ])
...
def exp(x: _atypes.TensorFuzzingAnnotation[TV_Exp_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Exp_T]:
...
def exp_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Exp_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Exp_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, _dtypes.complex64, _dtypes.complex128, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def expm1(x: _atypes.TensorFuzzingAnnotation[TV_Expm1_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Expm1_T]:
...
def expm1_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Expm1_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Expm1_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, _dtypes.complex64, _dtypes.complex128, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def floor(x: _atypes.TensorFuzzingAnnotation[TV_Floor_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Floor_T]:
...
def floor_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Floor_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Floor_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def floor_div(x: _atypes.TensorFuzzingAnnotation[TV_FloorDiv_T], y: _atypes.TensorFuzzingAnnotation[TV_FloorDiv_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_FloorDiv_T]:
  r"""Returns x // y element-wise.
...
def floor_div_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_FloorDiv_T], y: _atypes.TensorFuzzingAnnotation[TV_FloorDiv_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_FloorDiv_T]:
  _attr_T, _inputs_T = _execute.args_to_matching_eager([x, y], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, _dtypes.uint8, _dtypes.int8, _dtypes.uint16, _dtypes.int16, _dtypes.int32, _dtypes.uint32, _dtypes.uint64, _dtypes.int64, _dtypes.complex64, _dtypes.complex128, ])
  (x, y) = _inputs_T
  _inputs_flat = [x, y]
  _attrs = ("T", _attr_T)
...
def floor_mod(x: _atypes.TensorFuzzingAnnotation[TV_FloorMod_T], y: _atypes.TensorFuzzingAnnotation[TV_FloorMod_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_FloorMod_T]:
...
def floor_mod_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_FloorMod_T], y: _atypes.TensorFuzzingAnnotation[TV_FloorMod_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_FloorMod_T]:
...
def greater(x: _atypes.TensorFuzzingAnnotation[TV_Greater_T], y: _atypes.TensorFuzzingAnnotation[TV_Greater_T], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
  r"""Returns the truth value of (x > y) element-wise.
...
def greater_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Greater_T], y: _atypes.TensorFuzzingAnnotation[TV_Greater_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
...
def greater_equal(x: _atypes.TensorFuzzingAnnotation[TV_GreaterEqual_T], y: _atypes.TensorFuzzingAnnotation[TV_GreaterEqual_T], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
  r"""Returns the truth value of (x >= y) element-wise.
...
def greater_equal_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_GreaterEqual_T], y: _atypes.TensorFuzzingAnnotation[TV_GreaterEqual_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
  _attr_T, _inputs_T = _execute.args_to_matching_eager([x, y], ctx, [_dtypes.float32, _dtypes.float64, _dtypes.int32, _dtypes.uint8, _dtypes.int16, _dtypes.int8, _dtypes.int64, _dtypes.bfloat16, _dtypes.uint16, _dtypes.half, _dtypes.uint32, _dtypes.uint64, ])
  (x, y) = _inputs_T
  _inputs_flat = [x, y]
  _attrs = ("T", _attr_T)
...
def igamma_eager_fallback(a: _atypes.TensorFuzzingAnnotation[TV_Igamma_T], x: _atypes.TensorFuzzingAnnotation[TV_Igamma_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Igamma_T]:
...
def igamma_grad_a_eager_fallback(a: _atypes.TensorFuzzingAnnotation[TV_IgammaGradA_T], x: _atypes.TensorFuzzingAnnotation[TV_IgammaGradA_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_IgammaGradA_T]:
...
def igammac_eager_fallback(a: _atypes.TensorFuzzingAnnotation[TV_Igammac_T], x: _atypes.TensorFuzzingAnnotation[TV_Igammac_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Igammac_T]:
  _attr_T, _inputs_T = _execute.args_to_matching_eager([a, x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, ])
  (a, x) = _inputs_T
  _inputs_flat = [a, x]
  _attrs = ("T", _attr_T)
...
def imag(input: _atypes.TensorFuzzingAnnotation[TV_Imag_T], Tout:TV_Imag_Tout=_dtypes.float32, name=None) -> _atypes.TensorFuzzingAnnotation[TV_Imag_Tout]:
...
def imag_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_Imag_T], Tout: TV_Imag_Tout, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Imag_Tout]:
  if Tout is None:
    Tout = _dtypes.float32
  Tout = _execute.make_type(Tout, "Tout")
  _attr_T, (input,) = _execute.args_to_matching_eager([input], ctx, [_dtypes.complex64, _dtypes.complex128, ], _dtypes.complex64)
...
def inv(x: _atypes.TensorFuzzingAnnotation[TV_Inv_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Inv_T]:
...
def inv_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Inv_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Inv_T]:
...
def inv_grad(y: _atypes.TensorFuzzingAnnotation[TV_InvGrad_T], dy: _atypes.TensorFuzzingAnnotation[TV_InvGrad_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_InvGrad_T]:
...
def inv_grad_eager_fallback(y: _atypes.TensorFuzzingAnnotation[TV_InvGrad_T], dy: _atypes.TensorFuzzingAnnotation[TV_InvGrad_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_InvGrad_T]:
...
def is_finite(x: _atypes.TensorFuzzingAnnotation[TV_IsFinite_T], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
...
def is_finite_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_IsFinite_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def is_inf(x: _atypes.TensorFuzzingAnnotation[TV_IsInf_T], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
...
def is_inf_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_IsInf_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def is_nan_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_IsNan_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def less(x: _atypes.TensorFuzzingAnnotation[TV_Less_T], y: _atypes.TensorFuzzingAnnotation[TV_Less_T], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
  r"""Returns the truth value of (x < y) element-wise.
...
def less_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Less_T], y: _atypes.TensorFuzzingAnnotation[TV_Less_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
  _attr_T, _inputs_T = _execute.args_to_matching_eager([x, y], ctx, [_dtypes.float32, _dtypes.float64, _dtypes.int32, _dtypes.uint8, _dtypes.int16, _dtypes.int8, _dtypes.int64, _dtypes.bfloat16, _dtypes.uint16, _dtypes.half, _dtypes.uint32, _dtypes.uint64, ])
  (x, y) = _inputs_T
  _inputs_flat = [x, y]
  _attrs = ("T", _attr_T)
...
def less_equal(x: _atypes.TensorFuzzingAnnotation[TV_LessEqual_T], y: _atypes.TensorFuzzingAnnotation[TV_LessEqual_T], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
  r"""Returns the truth value of (x <= y) element-wise.
...
def less_equal_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_LessEqual_T], y: _atypes.TensorFuzzingAnnotation[TV_LessEqual_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
  _attr_T, _inputs_T = _execute.args_to_matching_eager([x, y], ctx, [_dtypes.float32, _dtypes.float64, _dtypes.int32, _dtypes.uint8, _dtypes.int16, _dtypes.int8, _dtypes.int64, _dtypes.bfloat16, _dtypes.uint16, _dtypes.half, _dtypes.uint32, _dtypes.uint64, ])
  (x, y) = _inputs_T
  _inputs_flat = [x, y]
  _attrs = ("T", _attr_T)
...
def lgamma(x: _atypes.TensorFuzzingAnnotation[TV_Lgamma_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Lgamma_T]:
...
def lgamma_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Lgamma_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Lgamma_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def log(x: _atypes.TensorFuzzingAnnotation[TV_Log_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Log_T]:
...
def log_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Log_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Log_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, _dtypes.complex64, _dtypes.complex128, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def log1p(x: _atypes.TensorFuzzingAnnotation[TV_Log1p_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Log1p_T]:
...
def log1p_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Log1p_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Log1p_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, _dtypes.complex64, _dtypes.complex128, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def logical_and(x: _atypes.TensorFuzzingAnnotation[_atypes.Bool], y: _atypes.TensorFuzzingAnnotation[_atypes.Bool], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
...
def logical_and_eager_fallback(x: _atypes.TensorFuzzingAnnotation[_atypes.Bool], y: _atypes.TensorFuzzingAnnotation[_atypes.Bool], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
...
def logical_not(x: _atypes.TensorFuzzingAnnotation[_atypes.Bool], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
...
def logical_not_eager_fallback(x: _atypes.TensorFuzzingAnnotation[_atypes.Bool], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
  x = _ops.convert_to_tensor(x, _dtypes.bool)
  _inputs_flat = [x]
  _attrs = None
...
def logical_or(x: _atypes.TensorFuzzingAnnotation[_atypes.Bool], y: _atypes.TensorFuzzingAnnotation[_atypes.Bool], name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
...
def logical_or_eager_fallback(x: _atypes.TensorFuzzingAnnotation[_atypes.Bool], y: _atypes.TensorFuzzingAnnotation[_atypes.Bool], name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
  x = _ops.convert_to_tensor(x, _dtypes.bool)
  y = _ops.convert_to_tensor(y, _dtypes.bool)
  _inputs_flat = [x, y]
  _attrs = None
...
def mat_mul(a: _atypes.TensorFuzzingAnnotation[TV_MatMul_T], b: _atypes.TensorFuzzingAnnotation[TV_MatMul_T], transpose_a:bool=False, transpose_b:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[TV_MatMul_T]:
...
def mat_mul_eager_fallback(a: _atypes.TensorFuzzingAnnotation[TV_MatMul_T], b: _atypes.TensorFuzzingAnnotation[TV_MatMul_T], transpose_a: bool, transpose_b: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_MatMul_T]:
  if transpose_a is None:
    transpose_a = False
  transpose_a = _execute.make_bool(transpose_a, "transpose_a")
  if transpose_b is None:
...
def _max(input: _atypes.TensorFuzzingAnnotation[TV_Max_T], axis: _atypes.TensorFuzzingAnnotation[TV_Max_Tidx], keep_dims:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[TV_Max_T]:
...
def _max_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_Max_T], axis: _atypes.TensorFuzzingAnnotation[TV_Max_Tidx], keep_dims: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Max_T]:
  if keep_dims is None:
    keep_dims = False
  keep_dims = _execute.make_bool(keep_dims, "keep_dims")
...
def maximum(x: _atypes.TensorFuzzingAnnotation[TV_Maximum_T], y: _atypes.TensorFuzzingAnnotation[TV_Maximum_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Maximum_T]:
...
def maximum_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Maximum_T], y: _atypes.TensorFuzzingAnnotation[TV_Maximum_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Maximum_T]:
...
def mean(input: _atypes.TensorFuzzingAnnotation[TV_Mean_T], axis: _atypes.TensorFuzzingAnnotation[TV_Mean_Tidx], keep_dims:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[TV_Mean_T]:
...
def mean_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_Mean_T], axis: _atypes.TensorFuzzingAnnotation[TV_Mean_Tidx], keep_dims: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Mean_T]:
  if keep_dims is None:
    keep_dims = False
  keep_dims = _execute.make_bool(keep_dims, "keep_dims")
  _attr_T, (input,) = _execute.args_to_matching_eager([input], ctx, [_dtypes.float32, _dtypes.float64, _dtypes.int32, _dtypes.uint8, _dtypes.int16, _dtypes.int8, _dtypes.complex64, _dtypes.int64, _dtypes.qint8, _dtypes.quint8, _dtypes.qint32, _dtypes.bfloat16, _dtypes.qint16, _dtypes.quint16, _dtypes.uint16, _dtypes.complex128, _dtypes.half, _dtypes.uint32, _dtypes.uint64, ])
...
def _min_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_Min_T], axis: _atypes.TensorFuzzingAnnotation[TV_Min_Tidx], keep_dims: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Min_T]:
  if keep_dims is None:
    keep_dims = False
  keep_dims = _execute.make_bool(keep_dims, "keep_dims")
  _attr_T, (input,) = _execute.args_to_matching_eager([input], ctx, [_dtypes.float32, _dtypes.float64, _dtypes.int32, _dtypes.uint8, _dtypes.int16, _dtypes.int8, _dtypes.int64, _dtypes.bfloat16, _dtypes.uint16, _dtypes.half, _dtypes.uint32, _dtypes.uint64, _dtypes.qint8, _dtypes.quint8, _dtypes.qint32, _dtypes.qint16, _dtypes.quint16, ])
...
def minimum(x: _atypes.TensorFuzzingAnnotation[TV_Minimum_T], y: _atypes.TensorFuzzingAnnotation[TV_Minimum_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Minimum_T]:
...
def minimum_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Minimum_T], y: _atypes.TensorFuzzingAnnotation[TV_Minimum_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Minimum_T]:
  _attr_T, _inputs_T = _execute.args_to_matching_eager([x, y], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, _dtypes.int8, _dtypes.uint8, _dtypes.int16, _dtypes.uint16, _dtypes.int32, _dtypes.uint32, _dtypes.int64, _dtypes.uint64, ])
  (x, y) = _inputs_T
  _inputs_flat = [x, y]
  _attrs = ("T", _attr_T)
...
def mod(x: _atypes.TensorFuzzingAnnotation[TV_Mod_T], y: _atypes.TensorFuzzingAnnotation[TV_Mod_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Mod_T]:
...
def mod_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Mod_T], y: _atypes.TensorFuzzingAnnotation[TV_Mod_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Mod_T]:
...
def mul(x: _atypes.TensorFuzzingAnnotation[TV_Mul_T], y: _atypes.TensorFuzzingAnnotation[TV_Mul_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Mul_T]:
  r"""Returns x * y element-wise.
...
def mul_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Mul_T], y: _atypes.TensorFuzzingAnnotation[TV_Mul_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Mul_T]:
  _attr_T, _inputs_T = _execute.args_to_matching_eager([x, y], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, _dtypes.uint8, _dtypes.int8, _dtypes.uint16, _dtypes.int16, _dtypes.int32, _dtypes.uint32, _dtypes.uint64, _dtypes.int64, _dtypes.complex64, _dtypes.complex128, ])
  (x, y) = _inputs_T
  _inputs_flat = [x, y]
  _attrs = ("T", _attr_T)
...
def mul_no_nan_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_MulNoNan_T], y: _atypes.TensorFuzzingAnnotation[TV_MulNoNan_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_MulNoNan_T]:
...
def ndtri(x: _atypes.TensorFuzzingAnnotation[TV_Ndtri_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Ndtri_T]:
  r"""TODO: add doc.
...
def ndtri_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Ndtri_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Ndtri_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def neg(x: _atypes.TensorFuzzingAnnotation[TV_Neg_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Neg_T]:
...
def neg_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Neg_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Neg_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, _dtypes.int8, _dtypes.int16, _dtypes.int32, _dtypes.int64, _dtypes.complex64, _dtypes.complex128, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def next_after_eager_fallback(x1: _atypes.TensorFuzzingAnnotation[TV_NextAfter_T], x2: _atypes.TensorFuzzingAnnotation[TV_NextAfter_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_NextAfter_T]:
...
TV_NotEqual_T = TypeVar("TV_NotEqual_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def not_equal(x: _atypes.TensorFuzzingAnnotation[TV_NotEqual_T], y: _atypes.TensorFuzzingAnnotation[TV_NotEqual_T], incompatible_shape_error:bool=True, name=None) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
  r"""Returns the truth value of (x != y) element-wise.
...
def not_equal_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_NotEqual_T], y: _atypes.TensorFuzzingAnnotation[TV_NotEqual_T], incompatible_shape_error: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[_atypes.Bool]:
  if incompatible_shape_error is None:
    incompatible_shape_error = True
  incompatible_shape_error = _execute.make_bool(incompatible_shape_error, "incompatible_shape_error")
  _attr_T, _inputs_T = _execute.args_to_matching_eager([x, y], ctx, [])
...
def polygamma_eager_fallback(a: _atypes.TensorFuzzingAnnotation[TV_Polygamma_T], x: _atypes.TensorFuzzingAnnotation[TV_Polygamma_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Polygamma_T]:
  _attr_T, _inputs_T = _execute.args_to_matching_eager([a, x], ctx, [_dtypes.float32, _dtypes.float64, ])
  (a, x) = _inputs_T
  _inputs_flat = [a, x]
  _attrs = ("T", _attr_T)
...
def _pow(x: _atypes.TensorFuzzingAnnotation[TV_Pow_T], y: _atypes.TensorFuzzingAnnotation[TV_Pow_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Pow_T]:
...
def _pow_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Pow_T], y: _atypes.TensorFuzzingAnnotation[TV_Pow_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Pow_T]:
...
def prod(input: _atypes.TensorFuzzingAnnotation[TV_Prod_T], axis: _atypes.TensorFuzzingAnnotation[TV_Prod_Tidx], keep_dims:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[TV_Prod_T]:
...
def prod_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_Prod_T], axis: _atypes.TensorFuzzingAnnotation[TV_Prod_Tidx], keep_dims: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Prod_T]:
  if keep_dims is None:
    keep_dims = False
  keep_dims = _execute.make_bool(keep_dims, "keep_dims")
  _attr_T, (input,) = _execute.args_to_matching_eager([input], ctx, [_dtypes.float32, _dtypes.float64, _dtypes.int32, _dtypes.uint8, _dtypes.int16, _dtypes.int8, _dtypes.complex64, _dtypes.int64, _dtypes.qint8, _dtypes.quint8, _dtypes.qint32, _dtypes.bfloat16, _dtypes.qint16, _dtypes.quint16, _dtypes.uint16, _dtypes.complex128, _dtypes.half, _dtypes.uint32, _dtypes.uint64, ])
...
def quantize_down_and_shrink_range(input: _atypes.TensorFuzzingAnnotation[TV_QuantizeDownAndShrinkRange_Tinput], input_min: _atypes.TensorFuzzingAnnotation[_atypes.Float32], input_max: _atypes.TensorFuzzingAnnotation[_atypes.Float32], out_type: TV_QuantizeDownAndShrinkRange_out_type, name=None):
...
def quantized_add(x: _atypes.TensorFuzzingAnnotation[TV_QuantizedAdd_T1], y: _atypes.TensorFuzzingAnnotation[TV_QuantizedAdd_T2], min_x: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_x: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_y: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_y: _atypes.TensorFuzzingAnnotation[_atypes.Float32], Toutput:TV_QuantizedAdd_Toutput=_dtypes.qint32, name=None):
...
def quantized_mat_mul_eager_fallback(a: _atypes.TensorFuzzingAnnotation[TV_QuantizedMatMul_T1], b: _atypes.TensorFuzzingAnnotation[TV_QuantizedMatMul_T2], min_a: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_a: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_b: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_b: _atypes.TensorFuzzingAnnotation[_atypes.Float32], Toutput: TV_QuantizedMatMul_Toutput, transpose_a: bool, transpose_b: bool, Tactivation: TV_QuantizedMatMul_Tactivation, name, ctx):
  if Toutput is None:
    Toutput = _dtypes.qint32
  Toutput = _execute.make_type(Toutput, "Toutput")
  if transpose_a is None:
...
def quantized_mul_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_QuantizedMul_T1], y: _atypes.TensorFuzzingAnnotation[TV_QuantizedMul_T2], min_x: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_x: _atypes.TensorFuzzingAnnotation[_atypes.Float32], min_y: _atypes.TensorFuzzingAnnotation[_atypes.Float32], max_y: _atypes.TensorFuzzingAnnotation[_atypes.Float32], Toutput: TV_QuantizedMul_Toutput, name, ctx):
  if Toutput is None:
    Toutput = _dtypes.qint32
  Toutput = _execute.make_type(Toutput, "Toutput")
  _attr_T1, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.qint8, _dtypes.quint8, _dtypes.qint32, _dtypes.qint16, _dtypes.quint16, ])
...
def ragged_bincount_eager_fallback(splits: _atypes.TensorFuzzingAnnotation[_atypes.Int64], values: _atypes.TensorFuzzingAnnotation[TV_RaggedBincount_Tidx], size: _atypes.TensorFuzzingAnnotation[TV_RaggedBincount_Tidx], weights: _atypes.TensorFuzzingAnnotation[TV_RaggedBincount_T], binary_output: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_RaggedBincount_T]:
  if binary_output is None:
    binary_output = False
  binary_output = _execute.make_bool(binary_output, "binary_output")
...
def _range(start: _atypes.TensorFuzzingAnnotation[TV_Range_Tidx], limit: _atypes.TensorFuzzingAnnotation[TV_Range_Tidx], delta: _atypes.TensorFuzzingAnnotation[TV_Range_Tidx], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Range_Tidx]:
...
def real(input: _atypes.TensorFuzzingAnnotation[TV_Real_T], Tout:TV_Real_Tout=_dtypes.float32, name=None) -> _atypes.TensorFuzzingAnnotation[TV_Real_Tout]:
...
def real_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_Real_T], Tout: TV_Real_Tout, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Real_Tout]:
  if Tout is None:
    Tout = _dtypes.float32
  Tout = _execute.make_type(Tout, "Tout")
  _attr_T, (input,) = _execute.args_to_matching_eager([input], ctx, [_dtypes.complex64, _dtypes.complex128, ], _dtypes.complex64)
...
def real_div_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_RealDiv_T], y: _atypes.TensorFuzzingAnnotation[TV_RealDiv_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_RealDiv_T]:
  _attr_T, _inputs_T = _execute.args_to_matching_eager([x, y], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, _dtypes.uint8, _dtypes.int8, _dtypes.uint16, _dtypes.int16, _dtypes.int32, _dtypes.uint32, _dtypes.uint64, _dtypes.int64, _dtypes.complex64, _dtypes.complex128, ])
  (x, y) = _inputs_T
  _inputs_flat = [x, y]
  _attrs = ("T", _attr_T)
...
def reciprocal(x: _atypes.TensorFuzzingAnnotation[TV_Reciprocal_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Reciprocal_T]:
  r"""Computes the reciprocal of x element-wise.
...
def reciprocal_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Reciprocal_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Reciprocal_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, _dtypes.int8, _dtypes.int16, _dtypes.int32, _dtypes.int64, _dtypes.complex64, _dtypes.complex128, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def reciprocal_grad(y: _atypes.TensorFuzzingAnnotation[TV_ReciprocalGrad_T], dy: _atypes.TensorFuzzingAnnotation[TV_ReciprocalGrad_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_ReciprocalGrad_T]:
  r"""Computes the gradient for the inverse of `x` wrt its input.
...
def reciprocal_grad_eager_fallback(y: _atypes.TensorFuzzingAnnotation[TV_ReciprocalGrad_T], dy: _atypes.TensorFuzzingAnnotation[TV_ReciprocalGrad_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_ReciprocalGrad_T]:
  _attr_T, _inputs_T = _execute.args_to_matching_eager([y, dy], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, _dtypes.complex64, _dtypes.complex128, ])
  (y, dy) = _inputs_T
  _inputs_flat = [y, dy]
  _attrs = ("T", _attr_T)
...
def requantization_range_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_RequantizationRange_Tinput], input_min: _atypes.TensorFuzzingAnnotation[_atypes.Float32], input_max: _atypes.TensorFuzzingAnnotation[_atypes.Float32], name, ctx):
  _attr_Tinput, (input,) = _execute.args_to_matching_eager([input], ctx, [_dtypes.qint8, _dtypes.quint8, _dtypes.qint32, _dtypes.qint16, _dtypes.quint16, ])
  input_min = _ops.convert_to_tensor(input_min, _dtypes.float32)
  input_max = _ops.convert_to_tensor(input_max, _dtypes.float32)
  _inputs_flat = [input, input_min, input_max]
...
def requantize_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_Requantize_Tinput], input_min: _atypes.TensorFuzzingAnnotation[_atypes.Float32], input_max: _atypes.TensorFuzzingAnnotation[_atypes.Float32], requested_output_min: _atypes.TensorFuzzingAnnotation[_atypes.Float32], requested_output_max: _atypes.TensorFuzzingAnnotation[_atypes.Float32], out_type: TV_Requantize_out_type, name, ctx):
  out_type = _execute.make_type(out_type, "out_type")
  _attr_Tinput, (input,) = _execute.args_to_matching_eager([input], ctx, [_dtypes.qint8, _dtypes.quint8, _dtypes.qint32, _dtypes.qint16, _dtypes.quint16, ])
  input_min = _ops.convert_to_tensor(input_min, _dtypes.float32)
  input_max = _ops.convert_to_tensor(input_max, _dtypes.float32)
...
def requantize_per_channel_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_RequantizePerChannel_T], input_min: _atypes.TensorFuzzingAnnotation[_atypes.Float32], input_max: _atypes.TensorFuzzingAnnotation[_atypes.Float32], requested_output_min: _atypes.TensorFuzzingAnnotation[_atypes.Float32], requested_output_max: _atypes.TensorFuzzingAnnotation[_atypes.Float32], out_type: TV_RequantizePerChannel_out_type, name, ctx):
  if out_type is None:
    out_type = _dtypes.quint8
  out_type = _execute.make_type(out_type, "out_type")
  _attr_T, (input,) = _execute.args_to_matching_eager([input], ctx, [_dtypes.qint8, _dtypes.quint8, _dtypes.qint32, _dtypes.qint16, _dtypes.quint16, ], _dtypes.qint32)
...
def rint(x: _atypes.TensorFuzzingAnnotation[TV_Rint_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Rint_T]:
...
def rint_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Rint_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Rint_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def round(x: _atypes.TensorFuzzingAnnotation[TV_Round_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Round_T]:
...
def round_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Round_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Round_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, _dtypes.int8, _dtypes.int16, _dtypes.int32, _dtypes.int64, _dtypes.complex64, _dtypes.complex128, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def rsqrt(x: _atypes.TensorFuzzingAnnotation[TV_Rsqrt_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Rsqrt_T]:
...
def rsqrt_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Rsqrt_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Rsqrt_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, _dtypes.complex64, _dtypes.complex128, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def rsqrt_grad(y: _atypes.TensorFuzzingAnnotation[TV_RsqrtGrad_T], dy: _atypes.TensorFuzzingAnnotation[TV_RsqrtGrad_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_RsqrtGrad_T]:
...
def rsqrt_grad_eager_fallback(y: _atypes.TensorFuzzingAnnotation[TV_RsqrtGrad_T], dy: _atypes.TensorFuzzingAnnotation[TV_RsqrtGrad_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_RsqrtGrad_T]:
  _attr_T, _inputs_T = _execute.args_to_matching_eager([y, dy], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, _dtypes.complex64, _dtypes.complex128, ])
  (y, dy) = _inputs_T
  _inputs_flat = [y, dy]
  _attrs = ("T", _attr_T)
...
def segment_max(data: _atypes.TensorFuzzingAnnotation[TV_SegmentMax_T], segment_ids: _atypes.TensorFuzzingAnnotation[TV_SegmentMax_Tindices], name=None) -> _atypes.TensorFuzzingAnnotation[TV_SegmentMax_T]:
...
def segment_max_eager_fallback(data: _atypes.TensorFuzzingAnnotation[TV_SegmentMax_T], segment_ids: _atypes.TensorFuzzingAnnotation[TV_SegmentMax_Tindices], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_SegmentMax_T]:
...
def segment_max_v2_eager_fallback(data: _atypes.TensorFuzzingAnnotation[TV_SegmentMaxV2_T], segment_ids: _atypes.TensorFuzzingAnnotation[TV_SegmentMaxV2_Tindices], num_segments: _atypes.TensorFuzzingAnnotation[TV_SegmentMaxV2_Tnumsegments], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_SegmentMaxV2_T]:
  _attr_T, (data,) = _execute.args_to_matching_eager([data], ctx, [_dtypes.float32, _dtypes.float64, _dtypes.int32, _dtypes.uint8, _dtypes.int16, _dtypes.int8, _dtypes.int64, _dtypes.bfloat16, _dtypes.uint16, _dtypes.half, _dtypes.uint32, _dtypes.uint64, ])
  _attr_Tindices, (segment_ids,) = _execute.args_to_matching_eager([segment_ids], ctx, [_dtypes.int32, _dtypes.int64, ])
...
def segment_mean(data: _atypes.TensorFuzzingAnnotation[TV_SegmentMean_T], segment_ids: _atypes.TensorFuzzingAnnotation[TV_SegmentMean_Tindices], name=None) -> _atypes.TensorFuzzingAnnotation[TV_SegmentMean_T]:
...
def segment_min(data: _atypes.TensorFuzzingAnnotation[TV_SegmentMin_T], segment_ids: _atypes.TensorFuzzingAnnotation[TV_SegmentMin_Tindices], name=None) -> _atypes.TensorFuzzingAnnotation[TV_SegmentMin_T]:
...
def segment_min_eager_fallback(data: _atypes.TensorFuzzingAnnotation[TV_SegmentMin_T], segment_ids: _atypes.TensorFuzzingAnnotation[TV_SegmentMin_Tindices], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_SegmentMin_T]:
  _attr_T, (data,) = _execute.args_to_matching_eager([data], ctx, [_dtypes.float32, _dtypes.float64, _dtypes.int32, _dtypes.uint8, _dtypes.int16, _dtypes.int8, _dtypes.int64, _dtypes.bfloat16, _dtypes.uint16, _dtypes.half, _dtypes.uint32, _dtypes.uint64, ])
  _attr_Tindices, (segment_ids,) = _execute.args_to_matching_eager([segment_ids], ctx, [_dtypes.int32, _dtypes.int64, ])
  _inputs_flat = [data, segment_ids]
  _attrs = ("T", _attr_T, "Tindices", _attr_Tindices)
...
def segment_min_v2(data: _atypes.TensorFuzzingAnnotation[TV_SegmentMinV2_T], segment_ids: _atypes.TensorFuzzingAnnotation[TV_SegmentMinV2_Tindices], num_segments: _atypes.TensorFuzzingAnnotation[TV_SegmentMinV2_Tnumsegments], name=None) -> _atypes.TensorFuzzingAnnotation[TV_SegmentMinV2_T]:
  r"""Computes the minimum along segments of a tensor.
...
def segment_min_v2_eager_fallback(data: _atypes.TensorFuzzingAnnotation[TV_SegmentMinV2_T], segment_ids: _atypes.TensorFuzzingAnnotation[TV_SegmentMinV2_Tindices], num_segments: _atypes.TensorFuzzingAnnotation[TV_SegmentMinV2_Tnumsegments], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_SegmentMinV2_T]:
  _attr_T, (data,) = _execute.args_to_matching_eager([data], ctx, [_dtypes.float32, _dtypes.float64, _dtypes.int32, _dtypes.uint8, _dtypes.int16, _dtypes.int8, _dtypes.int64, _dtypes.bfloat16, _dtypes.uint16, _dtypes.half, _dtypes.uint32, _dtypes.uint64, ])
  _attr_Tindices, (segment_ids,) = _execute.args_to_matching_eager([segment_ids], ctx, [_dtypes.int32, _dtypes.int64, ])
  _attr_Tnumsegments, (num_segments,) = _execute.args_to_matching_eager([num_segments], ctx, [_dtypes.int32, _dtypes.int64, ], _dtypes.int32)
  _inputs_flat = [data, segment_ids, num_segments]
...
def segment_prod(data: _atypes.TensorFuzzingAnnotation[TV_SegmentProd_T], segment_ids: _atypes.TensorFuzzingAnnotation[TV_SegmentProd_Tindices], name=None) -> _atypes.TensorFuzzingAnnotation[TV_SegmentProd_T]:
...
def segment_prod_eager_fallback(data: _atypes.TensorFuzzingAnnotation[TV_SegmentProd_T], segment_ids: _atypes.TensorFuzzingAnnotation[TV_SegmentProd_Tindices], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_SegmentProd_T]:
  _attr_T, (data,) = _execute.args_to_matching_eager([data], ctx, [_dtypes.float32, _dtypes.float64, _dtypes.int32, _dtypes.uint8, _dtypes.int16, _dtypes.int8, _dtypes.complex64, _dtypes.int64, _dtypes.qint8, _dtypes.quint8, _dtypes.qint32, _dtypes.bfloat16, _dtypes.qint16, _dtypes.quint16, _dtypes.uint16, _dtypes.complex128, _dtypes.half, _dtypes.uint32, _dtypes.uint64, ])
  _attr_Tindices, (segment_ids,) = _execute.args_to_matching_eager([segment_ids], ctx, [_dtypes.int32, _dtypes.int64, ])
  _inputs_flat = [data, segment_ids]
  _attrs = ("T", _attr_T, "Tindices", _attr_Tindices)
...
def segment_prod_v2(data: _atypes.TensorFuzzingAnnotation[TV_SegmentProdV2_T], segment_ids: _atypes.TensorFuzzingAnnotation[TV_SegmentProdV2_Tindices], num_segments: _atypes.TensorFuzzingAnnotation[TV_SegmentProdV2_Tnumsegments], name=None) -> _atypes.TensorFuzzingAnnotation[TV_SegmentProdV2_T]:
  r"""Computes the product along segments of a tensor.
...
def segment_prod_v2_eager_fallback(data: _atypes.TensorFuzzingAnnotation[TV_SegmentProdV2_T], segment_ids: _atypes.TensorFuzzingAnnotation[TV_SegmentProdV2_Tindices], num_segments: _atypes.TensorFuzzingAnnotation[TV_SegmentProdV2_Tnumsegments], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_SegmentProdV2_T]:
  _attr_T, (data,) = _execute.args_to_matching_eager([data], ctx, [_dtypes.float32, _dtypes.float64, _dtypes.int32, _dtypes.uint8, _dtypes.int16, _dtypes.int8, _dtypes.complex64, _dtypes.int64, _dtypes.qint8, _dtypes.quint8, _dtypes.qint32, _dtypes.bfloat16, _dtypes.qint16, _dtypes.quint16, _dtypes.uint16, _dtypes.complex128, _dtypes.half, _dtypes.uint32, _dtypes.uint64, ])
  _attr_Tindices, (segment_ids,) = _execute.args_to_matching_eager([segment_ids], ctx, [_dtypes.int32, _dtypes.int64, ])
  _attr_Tnumsegments, (num_segments,) = _execute.args_to_matching_eager([num_segments], ctx, [_dtypes.int32, _dtypes.int64, ], _dtypes.int32)
  _inputs_flat = [data, segment_ids, num_segments]
...
def segment_sum(data: _atypes.TensorFuzzingAnnotation[TV_SegmentSum_T], segment_ids: _atypes.TensorFuzzingAnnotation[TV_SegmentSum_Tindices], name=None) -> _atypes.TensorFuzzingAnnotation[TV_SegmentSum_T]:
...
def segment_sum_eager_fallback(data: _atypes.TensorFuzzingAnnotation[TV_SegmentSum_T], segment_ids: _atypes.TensorFuzzingAnnotation[TV_SegmentSum_Tindices], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_SegmentSum_T]:
  _attr_T, (data,) = _execute.args_to_matching_eager([data], ctx, [_dtypes.float32, _dtypes.float64, _dtypes.int32, _dtypes.uint8, _dtypes.int16, _dtypes.int8, _dtypes.complex64, _dtypes.int64, _dtypes.qint8, _dtypes.quint8, _dtypes.qint32, _dtypes.bfloat16, _dtypes.qint16, _dtypes.quint16, _dtypes.uint16, _dtypes.complex128, _dtypes.half, _dtypes.uint32, _dtypes.uint64, ])
  _attr_Tindices, (segment_ids,) = _execute.args_to_matching_eager([segment_ids], ctx, [_dtypes.int32, _dtypes.int64, ])
  _inputs_flat = [data, segment_ids]
  _attrs = ("T", _attr_T, "Tindices", _attr_Tindices)
...
def segment_sum_v2_eager_fallback(data: _atypes.TensorFuzzingAnnotation[TV_SegmentSumV2_T], segment_ids: _atypes.TensorFuzzingAnnotation[TV_SegmentSumV2_Tindices], num_segments: _atypes.TensorFuzzingAnnotation[TV_SegmentSumV2_Tnumsegments], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_SegmentSumV2_T]:
  _attr_T, (data,) = _execute.args_to_matching_eager([data], ctx, [_dtypes.float32, _dtypes.float64, _dtypes.int32, _dtypes.uint8, _dtypes.int16, _dtypes.int8, _dtypes.complex64, _dtypes.int64, _dtypes.qint8, _dtypes.quint8, _dtypes.qint32, _dtypes.bfloat16, _dtypes.qint16, _dtypes.quint16, _dtypes.uint16, _dtypes.complex128, _dtypes.half, _dtypes.uint32, _dtypes.uint64, ])
  _attr_Tindices, (segment_ids,) = _execute.args_to_matching_eager([segment_ids], ctx, [_dtypes.int32, _dtypes.int64, ])
  _attr_Tnumsegments, (num_segments,) = _execute.args_to_matching_eager([num_segments], ctx, [_dtypes.int32, _dtypes.int64, ], _dtypes.int32)
  _inputs_flat = [data, segment_ids, num_segments]
...
TV_Select_T = TypeVar("TV_Select_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def select(condition: _atypes.TensorFuzzingAnnotation[_atypes.Bool], x: _atypes.TensorFuzzingAnnotation[TV_Select_T], y: _atypes.TensorFuzzingAnnotation[TV_Select_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Select_T]:
...
TV_SelectV2_T = TypeVar("TV_SelectV2_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def select_v2(condition: _atypes.TensorFuzzingAnnotation[_atypes.Bool], t: _atypes.TensorFuzzingAnnotation[TV_SelectV2_T], e: _atypes.TensorFuzzingAnnotation[TV_SelectV2_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_SelectV2_T]:
  r"""TODO: add doc.
...
def select_v2_eager_fallback(condition: _atypes.TensorFuzzingAnnotation[_atypes.Bool], t: _atypes.TensorFuzzingAnnotation[TV_SelectV2_T], e: _atypes.TensorFuzzingAnnotation[TV_SelectV2_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_SelectV2_T]:
...
def sigmoid(x: _atypes.TensorFuzzingAnnotation[TV_Sigmoid_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Sigmoid_T]:
...
def sigmoid_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Sigmoid_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Sigmoid_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, _dtypes.complex64, _dtypes.complex128, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def sigmoid_grad(y: _atypes.TensorFuzzingAnnotation[TV_SigmoidGrad_T], dy: _atypes.TensorFuzzingAnnotation[TV_SigmoidGrad_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_SigmoidGrad_T]:
...
def sigmoid_grad_eager_fallback(y: _atypes.TensorFuzzingAnnotation[TV_SigmoidGrad_T], dy: _atypes.TensorFuzzingAnnotation[TV_SigmoidGrad_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_SigmoidGrad_T]:
  _attr_T, _inputs_T = _execute.args_to_matching_eager([y, dy], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, _dtypes.complex64, _dtypes.complex128, ])
  (y, dy) = _inputs_T
  _inputs_flat = [y, dy]
  _attrs = ("T", _attr_T)
...
def sign(x: _atypes.TensorFuzzingAnnotation[TV_Sign_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Sign_T]:
...
def sign_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Sign_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Sign_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, _dtypes.int8, _dtypes.int16, _dtypes.int32, _dtypes.int64, _dtypes.complex64, _dtypes.complex128, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def sin(x: _atypes.TensorFuzzingAnnotation[TV_Sin_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Sin_T]:
...
def sin_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Sin_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Sin_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, _dtypes.complex64, _dtypes.complex128, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def sinh(x: _atypes.TensorFuzzingAnnotation[TV_Sinh_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Sinh_T]:
...
def sinh_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Sinh_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Sinh_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, _dtypes.complex64, _dtypes.complex128, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def sobol_sample(dim: _atypes.TensorFuzzingAnnotation[_atypes.Int32], num_results: _atypes.TensorFuzzingAnnotation[_atypes.Int32], skip: _atypes.TensorFuzzingAnnotation[_atypes.Int32], dtype:TV_SobolSample_dtype=_dtypes.float32, name=None) -> _atypes.TensorFuzzingAnnotation[TV_SobolSample_dtype]:
...
def sparse_bincount(indices: _atypes.TensorFuzzingAnnotation[_atypes.Int64], values: _atypes.TensorFuzzingAnnotation[TV_SparseBincount_Tidx], dense_shape: _atypes.TensorFuzzingAnnotation[_atypes.Int64], size: _atypes.TensorFuzzingAnnotation[TV_SparseBincount_Tidx], weights: _atypes.TensorFuzzingAnnotation[TV_SparseBincount_T], binary_output:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[TV_SparseBincount_T]:
  r"""Counts the number of occurrences of each value in an integer array.
...
def sparse_segment_mean(data: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentMean_T], indices: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentMean_Tidx], segment_ids: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentMean_Tsegmentids], name=None) -> _atypes.TensorFuzzingAnnotation[TV_SparseSegmentMean_T]:
...
def sparse_segment_mean_eager_fallback(data: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentMean_T], indices: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentMean_Tidx], segment_ids: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentMean_Tsegmentids], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_SparseSegmentMean_T]:
...
def sparse_segment_mean_grad(grad: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentMeanGrad_T], indices: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentMeanGrad_Tidx], segment_ids: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentMeanGrad_Tsegmentids], output_dim0: _atypes.TensorFuzzingAnnotation[_atypes.Int32], name=None) -> _atypes.TensorFuzzingAnnotation[TV_SparseSegmentMeanGrad_T]:
...
def sparse_segment_mean_grad_eager_fallback(grad: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentMeanGrad_T], indices: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentMeanGrad_Tidx], segment_ids: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentMeanGrad_Tsegmentids], output_dim0: _atypes.TensorFuzzingAnnotation[_atypes.Int32], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_SparseSegmentMeanGrad_T]:
...
def sparse_segment_mean_grad_v2(grad: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentMeanGradV2_T], indices: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentMeanGradV2_Tidx], segment_ids: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentMeanGradV2_Tsegmentids], dense_output_dim0: _atypes.TensorFuzzingAnnotation[_atypes.Int32], name=None):
  r"""Computes gradients for SparseSegmentMean.
...
def sparse_segment_mean_grad_v2_eager_fallback(grad: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentMeanGradV2_T], indices: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentMeanGradV2_Tidx], segment_ids: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentMeanGradV2_Tsegmentids], dense_output_dim0: _atypes.TensorFuzzingAnnotation[_atypes.Int32], name, ctx):
  _attr_T, (grad,) = _execute.args_to_matching_eager([grad], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, ])
  _attr_Tidx, (indices,) = _execute.args_to_matching_eager([indices], ctx, [_dtypes.int32, _dtypes.int64, ], _dtypes.int32)
  _attr_Tsegmentids, (segment_ids,) = _execute.args_to_matching_eager([segment_ids], ctx, [_dtypes.int32, _dtypes.int64, ], _dtypes.int32)
...
def sparse_segment_mean_with_num_segments(data: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentMeanWithNumSegments_T], indices: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentMeanWithNumSegments_Tidx], segment_ids: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentMeanWithNumSegments_Tsegmentids], num_segments: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentMeanWithNumSegments_Tnumsegments], name=None) -> _atypes.TensorFuzzingAnnotation[TV_SparseSegmentMeanWithNumSegments_T]:
  r"""Computes the mean along sparse segments of a tensor.
...
def sparse_segment_mean_with_num_segments_eager_fallback(data: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentMeanWithNumSegments_T], indices: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentMeanWithNumSegments_Tidx], segment_ids: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentMeanWithNumSegments_Tsegmentids], num_segments: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentMeanWithNumSegments_Tnumsegments], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_SparseSegmentMeanWithNumSegments_T]:
  _attr_T, (data,) = _execute.args_to_matching_eager([data], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, ])
  _attr_Tidx, (indices,) = _execute.args_to_matching_eager([indices], ctx, [_dtypes.int32, _dtypes.int64, ], _dtypes.int32)
  _attr_Tnumsegments, (num_segments,) = _execute.args_to_matching_eager([num_segments], ctx, [_dtypes.int32, _dtypes.int64, ], _dtypes.int32)
  _attr_Tsegmentids, (segment_ids,) = _execute.args_to_matching_eager([segment_ids], ctx, [_dtypes.int32, _dtypes.int64, ], _dtypes.int32)
...
def sparse_segment_sqrt_n(data: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSqrtN_T], indices: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSqrtN_Tidx], segment_ids: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSqrtN_Tsegmentids], name=None) -> _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSqrtN_T]:
...
def sparse_segment_sqrt_n_eager_fallback(data: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSqrtN_T], indices: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSqrtN_Tidx], segment_ids: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSqrtN_Tsegmentids], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSqrtN_T]:
  _attr_T, (data,) = _execute.args_to_matching_eager([data], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, ])
  _attr_Tidx, (indices,) = _execute.args_to_matching_eager([indices], ctx, [_dtypes.int32, _dtypes.int64, ], _dtypes.int32)
  _attr_Tsegmentids, (segment_ids,) = _execute.args_to_matching_eager([segment_ids], ctx, [_dtypes.int32, _dtypes.int64, ], _dtypes.int32)
  _inputs_flat = [data, indices, segment_ids]
...
def sparse_segment_sqrt_n_grad(grad: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSqrtNGrad_T], indices: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSqrtNGrad_Tidx], segment_ids: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSqrtNGrad_Tsegmentids], output_dim0: _atypes.TensorFuzzingAnnotation[_atypes.Int32], name=None) -> _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSqrtNGrad_T]:
...
def sparse_segment_sqrt_n_grad_eager_fallback(grad: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSqrtNGrad_T], indices: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSqrtNGrad_Tidx], segment_ids: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSqrtNGrad_Tsegmentids], output_dim0: _atypes.TensorFuzzingAnnotation[_atypes.Int32], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSqrtNGrad_T]:
  _attr_T, (grad,) = _execute.args_to_matching_eager([grad], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, ])
  _attr_Tidx, (indices,) = _execute.args_to_matching_eager([indices], ctx, [_dtypes.int32, _dtypes.int64, ], _dtypes.int32)
  _attr_Tsegmentids, (segment_ids,) = _execute.args_to_matching_eager([segment_ids], ctx, [_dtypes.int32, _dtypes.int64, ], _dtypes.int32)
  output_dim0 = _ops.convert_to_tensor(output_dim0, _dtypes.int32)
...
def sparse_segment_sqrt_n_grad_v2_eager_fallback(grad: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSqrtNGradV2_T], indices: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSqrtNGradV2_Tidx], segment_ids: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSqrtNGradV2_Tsegmentids], dense_output_dim0: _atypes.TensorFuzzingAnnotation[_atypes.Int32], name, ctx):
  _attr_T, (grad,) = _execute.args_to_matching_eager([grad], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, ])
  _attr_Tidx, (indices,) = _execute.args_to_matching_eager([indices], ctx, [_dtypes.int32, _dtypes.int64, ], _dtypes.int32)
  _attr_Tsegmentids, (segment_ids,) = _execute.args_to_matching_eager([segment_ids], ctx, [_dtypes.int32, _dtypes.int64, ], _dtypes.int32)
  dense_output_dim0 = _ops.convert_to_tensor(dense_output_dim0, _dtypes.int32)
...
def sparse_segment_sum(data: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSum_T], indices: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSum_Tidx], segment_ids: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSum_Tsegmentids], name=None) -> _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSum_T]:
...
def sparse_segment_sum_eager_fallback(data: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSum_T], indices: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSum_Tidx], segment_ids: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSum_Tsegmentids], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSum_T]:
  _attr_T, (data,) = _execute.args_to_matching_eager([data], ctx, [_dtypes.float32, _dtypes.float64, _dtypes.int32, _dtypes.uint8, _dtypes.int16, _dtypes.int8, _dtypes.int64, _dtypes.bfloat16, _dtypes.uint16, _dtypes.half, _dtypes.uint32, _dtypes.uint64, ])
  _attr_Tidx, (indices,) = _execute.args_to_matching_eager([indices], ctx, [_dtypes.int32, _dtypes.int64, ], _dtypes.int32)
  _attr_Tsegmentids, (segment_ids,) = _execute.args_to_matching_eager([segment_ids], ctx, [_dtypes.int32, _dtypes.int64, ], _dtypes.int32)
  _inputs_flat = [data, indices, segment_ids]
...
def sparse_segment_sum_grad_v2(grad: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSumGradV2_T], indices: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSumGradV2_Tidx], segment_ids: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSumGradV2_Tsegmentids], dense_output_dim0: _atypes.TensorFuzzingAnnotation[_atypes.Int32], name=None):
  r"""Computes gradients for SparseSegmentSum.
...
def sparse_segment_sum_grad_v2_eager_fallback(grad: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSumGradV2_T], indices: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSumGradV2_Tidx], segment_ids: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSumGradV2_Tsegmentids], dense_output_dim0: _atypes.TensorFuzzingAnnotation[_atypes.Int32], name, ctx):
  _attr_T, (grad,) = _execute.args_to_matching_eager([grad], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, ])
  _attr_Tidx, (indices,) = _execute.args_to_matching_eager([indices], ctx, [_dtypes.int32, _dtypes.int64, ], _dtypes.int32)
  _attr_Tsegmentids, (segment_ids,) = _execute.args_to_matching_eager([segment_ids], ctx, [_dtypes.int32, _dtypes.int64, ], _dtypes.int32)
  dense_output_dim0 = _ops.convert_to_tensor(dense_output_dim0, _dtypes.int32)
...
def sparse_segment_sum_with_num_segments(data: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSumWithNumSegments_T], indices: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSumWithNumSegments_Tidx], segment_ids: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSumWithNumSegments_Tsegmentids], num_segments: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSumWithNumSegments_Tnumsegments], name=None) -> _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSumWithNumSegments_T]:
  r"""Computes the sum along sparse segments of a tensor.
...
def sparse_segment_sum_with_num_segments_eager_fallback(data: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSumWithNumSegments_T], indices: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSumWithNumSegments_Tidx], segment_ids: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSumWithNumSegments_Tsegmentids], num_segments: _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSumWithNumSegments_Tnumsegments], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_SparseSegmentSumWithNumSegments_T]:
  _attr_T, (data,) = _execute.args_to_matching_eager([data], ctx, [_dtypes.float32, _dtypes.float64, _dtypes.int32, _dtypes.uint8, _dtypes.int16, _dtypes.int8, _dtypes.int64, _dtypes.bfloat16, _dtypes.uint16, _dtypes.half, _dtypes.uint32, _dtypes.uint64, ])
  _attr_Tidx, (indices,) = _execute.args_to_matching_eager([indices], ctx, [_dtypes.int32, _dtypes.int64, ], _dtypes.int32)
  _attr_Tnumsegments, (num_segments,) = _execute.args_to_matching_eager([num_segments], ctx, [_dtypes.int32, _dtypes.int64, ], _dtypes.int32)
  _attr_Tsegmentids, (segment_ids,) = _execute.args_to_matching_eager([segment_ids], ctx, [_dtypes.int32, _dtypes.int64, ], _dtypes.int32)
...
def sqrt(x: _atypes.TensorFuzzingAnnotation[TV_Sqrt_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Sqrt_T]:
...
def sqrt_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Sqrt_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Sqrt_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, _dtypes.complex64, _dtypes.complex128, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def sqrt_grad(y: _atypes.TensorFuzzingAnnotation[TV_SqrtGrad_T], dy: _atypes.TensorFuzzingAnnotation[TV_SqrtGrad_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_SqrtGrad_T]:
...
def sqrt_grad_eager_fallback(y: _atypes.TensorFuzzingAnnotation[TV_SqrtGrad_T], dy: _atypes.TensorFuzzingAnnotation[TV_SqrtGrad_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_SqrtGrad_T]:
  _attr_T, _inputs_T = _execute.args_to_matching_eager([y, dy], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, _dtypes.complex64, _dtypes.complex128, ])
  (y, dy) = _inputs_T
  _inputs_flat = [y, dy]
  _attrs = ("T", _attr_T)
...
def square(x: _atypes.TensorFuzzingAnnotation[TV_Square_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Square_T]:
...
def square_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Square_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Square_T]:
...
def squared_difference(x: _atypes.TensorFuzzingAnnotation[TV_SquaredDifference_T], y: _atypes.TensorFuzzingAnnotation[TV_SquaredDifference_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_SquaredDifference_T]:
...
def squared_difference_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_SquaredDifference_T], y: _atypes.TensorFuzzingAnnotation[TV_SquaredDifference_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_SquaredDifference_T]:
  _attr_T, _inputs_T = _execute.args_to_matching_eager([x, y], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, _dtypes.int32, _dtypes.int64, _dtypes.complex64, _dtypes.complex128, ])
  (x, y) = _inputs_T
  _inputs_flat = [x, y]
  _attrs = ("T", _attr_T)
...
def sub(x: _atypes.TensorFuzzingAnnotation[TV_Sub_T], y: _atypes.TensorFuzzingAnnotation[TV_Sub_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Sub_T]:
  r"""Returns x - y element-wise.
...
def _sum(input: _atypes.TensorFuzzingAnnotation[TV_Sum_T], axis: _atypes.TensorFuzzingAnnotation[TV_Sum_Tidx], keep_dims:bool=False, name=None) -> _atypes.TensorFuzzingAnnotation[TV_Sum_T]:
...
def _sum_eager_fallback(input: _atypes.TensorFuzzingAnnotation[TV_Sum_T], axis: _atypes.TensorFuzzingAnnotation[TV_Sum_Tidx], keep_dims: bool, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Sum_T]:
  if keep_dims is None:
    keep_dims = False
  keep_dims = _execute.make_bool(keep_dims, "keep_dims")
  _attr_T, (input,) = _execute.args_to_matching_eager([input], ctx, [_dtypes.float32, _dtypes.float64, _dtypes.int32, _dtypes.uint8, _dtypes.int16, _dtypes.int8, _dtypes.complex64, _dtypes.int64, _dtypes.qint8, _dtypes.quint8, _dtypes.qint32, _dtypes.bfloat16, _dtypes.qint16, _dtypes.quint16, _dtypes.uint16, _dtypes.complex128, _dtypes.half, _dtypes.uint32, _dtypes.uint64, ])
...
def tan(x: _atypes.TensorFuzzingAnnotation[TV_Tan_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Tan_T]:
...
def tanh(x: _atypes.TensorFuzzingAnnotation[TV_Tanh_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Tanh_T]:
...
def tanh_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Tanh_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Tanh_T]:
  _attr_T, (x,) = _execute.args_to_matching_eager([x], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, _dtypes.complex64, _dtypes.complex128, ])
  _inputs_flat = [x]
  _attrs = ("T", _attr_T)
...
def tanh_grad(y: _atypes.TensorFuzzingAnnotation[TV_TanhGrad_T], dy: _atypes.TensorFuzzingAnnotation[TV_TanhGrad_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_TanhGrad_T]:
...
def tanh_grad_eager_fallback(y: _atypes.TensorFuzzingAnnotation[TV_TanhGrad_T], dy: _atypes.TensorFuzzingAnnotation[TV_TanhGrad_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_TanhGrad_T]:
  _attr_T, _inputs_T = _execute.args_to_matching_eager([y, dy], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, _dtypes.complex64, _dtypes.complex128, ])
  (y, dy) = _inputs_T
  _inputs_flat = [y, dy]
  _attrs = ("T", _attr_T)
...
def truncate_div(x: _atypes.TensorFuzzingAnnotation[TV_TruncateDiv_T], y: _atypes.TensorFuzzingAnnotation[TV_TruncateDiv_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_TruncateDiv_T]:
...
def truncate_div_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_TruncateDiv_T], y: _atypes.TensorFuzzingAnnotation[TV_TruncateDiv_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_TruncateDiv_T]:
  _attr_T, _inputs_T = _execute.args_to_matching_eager([x, y], ctx, [_dtypes.bfloat16, _dtypes.half, _dtypes.float32, _dtypes.float64, _dtypes.uint8, _dtypes.int8, _dtypes.uint16, _dtypes.int16, _dtypes.int32, _dtypes.uint32, _dtypes.uint64, _dtypes.int64, _dtypes.complex64, _dtypes.complex128, ])
  (x, y) = _inputs_T
  _inputs_flat = [x, y]
  _attrs = ("T", _attr_T)
...
def truncate_mod(x: _atypes.TensorFuzzingAnnotation[TV_TruncateMod_T], y: _atypes.TensorFuzzingAnnotation[TV_TruncateMod_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_TruncateMod_T]:
  r"""Returns element-wise remainder of division. This emulates C semantics in that
...
def truncate_mod_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_TruncateMod_T], y: _atypes.TensorFuzzingAnnotation[TV_TruncateMod_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_TruncateMod_T]:
...
def unsorted_segment_max_eager_fallback(data: _atypes.TensorFuzzingAnnotation[TV_UnsortedSegmentMax_T], segment_ids: _atypes.TensorFuzzingAnnotation[TV_UnsortedSegmentMax_Tindices], num_segments: _atypes.TensorFuzzingAnnotation[TV_UnsortedSegmentMax_Tnumsegments], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_UnsortedSegmentMax_T]:
  _attr_T, (data,) = _execute.args_to_matching_eager([data], ctx, [_dtypes.float32, _dtypes.float64, _dtypes.int32, _dtypes.uint8, _dtypes.int16, _dtypes.int8, _dtypes.int64, _dtypes.bfloat16, _dtypes.uint16, _dtypes.half, _dtypes.uint32, _dtypes.uint64, ])
  _attr_Tindices, (segment_ids,) = _execute.args_to_matching_eager([segment_ids], ctx, [_dtypes.int32, _dtypes.int64, ])
  _attr_Tnumsegments, (num_segments,) = _execute.args_to_matching_eager([num_segments], ctx, [_dtypes.int32, _dtypes.int64, ], _dtypes.int32)
  _inputs_flat = [data, segment_ids, num_segments]
...
def unsorted_segment_min(data: _atypes.TensorFuzzingAnnotation[TV_UnsortedSegmentMin_T], segment_ids: _atypes.TensorFuzzingAnnotation[TV_UnsortedSegmentMin_Tindices], num_segments: _atypes.TensorFuzzingAnnotation[TV_UnsortedSegmentMin_Tnumsegments], name=None) -> _atypes.TensorFuzzingAnnotation[TV_UnsortedSegmentMin_T]:
  r"""Computes the minimum along segments of a tensor.
...
def unsorted_segment_min_eager_fallback(data: _atypes.TensorFuzzingAnnotation[TV_UnsortedSegmentMin_T], segment_ids: _atypes.TensorFuzzingAnnotation[TV_UnsortedSegmentMin_Tindices], num_segments: _atypes.TensorFuzzingAnnotation[TV_UnsortedSegmentMin_Tnumsegments], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_UnsortedSegmentMin_T]:
  _attr_T, (data,) = _execute.args_to_matching_eager([data], ctx, [_dtypes.float32, _dtypes.float64, _dtypes.int32, _dtypes.uint8, _dtypes.int16, _dtypes.int8, _dtypes.int64, _dtypes.bfloat16, _dtypes.uint16, _dtypes.half, _dtypes.uint32, _dtypes.uint64, ])
  _attr_Tindices, (segment_ids,) = _execute.args_to_matching_eager([segment_ids], ctx, [_dtypes.int32, _dtypes.int64, ])
  _attr_Tnumsegments, (num_segments,) = _execute.args_to_matching_eager([num_segments], ctx, [_dtypes.int32, _dtypes.int64, ], _dtypes.int32)
  _inputs_flat = [data, segment_ids, num_segments]
...
def unsorted_segment_prod_eager_fallback(data: _atypes.TensorFuzzingAnnotation[TV_UnsortedSegmentProd_T], segment_ids: _atypes.TensorFuzzingAnnotation[TV_UnsortedSegmentProd_Tindices], num_segments: _atypes.TensorFuzzingAnnotation[TV_UnsortedSegmentProd_Tnumsegments], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_UnsortedSegmentProd_T]:
  _attr_T, (data,) = _execute.args_to_matching_eager([data], ctx, [_dtypes.float32, _dtypes.float64, _dtypes.int32, _dtypes.uint8, _dtypes.int16, _dtypes.int8, _dtypes.complex64, _dtypes.int64, _dtypes.qint8, _dtypes.quint8, _dtypes.qint32, _dtypes.bfloat16, _dtypes.qint16, _dtypes.quint16, _dtypes.uint16, _dtypes.complex128, _dtypes.half, _dtypes.uint32, _dtypes.uint64, ])
  _attr_Tindices, (segment_ids,) = _execute.args_to_matching_eager([segment_ids], ctx, [_dtypes.int32, _dtypes.int64, ])
  _attr_Tnumsegments, (num_segments,) = _execute.args_to_matching_eager([num_segments], ctx, [_dtypes.int32, _dtypes.int64, ], _dtypes.int32)
  _inputs_flat = [data, segment_ids, num_segments]
...
def unsorted_segment_sum(data: _atypes.TensorFuzzingAnnotation[TV_UnsortedSegmentSum_T], segment_ids: _atypes.TensorFuzzingAnnotation[TV_UnsortedSegmentSum_Tindices], num_segments: _atypes.TensorFuzzingAnnotation[TV_UnsortedSegmentSum_Tnumsegments], name=None) -> _atypes.TensorFuzzingAnnotation[TV_UnsortedSegmentSum_T]:
  r"""Computes the sum along segments of a tensor.
...
def unsorted_segment_sum_eager_fallback(data: _atypes.TensorFuzzingAnnotation[TV_UnsortedSegmentSum_T], segment_ids: _atypes.TensorFuzzingAnnotation[TV_UnsortedSegmentSum_Tindices], num_segments: _atypes.TensorFuzzingAnnotation[TV_UnsortedSegmentSum_Tnumsegments], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_UnsortedSegmentSum_T]:
  _attr_T, (data,) = _execute.args_to_matching_eager([data], ctx, [_dtypes.float32, _dtypes.float64, _dtypes.int32, _dtypes.uint8, _dtypes.int16, _dtypes.int8, _dtypes.complex64, _dtypes.int64, _dtypes.qint8, _dtypes.quint8, _dtypes.qint32, _dtypes.bfloat16, _dtypes.qint16, _dtypes.quint16, _dtypes.uint16, _dtypes.complex128, _dtypes.half, _dtypes.uint32, _dtypes.uint64, ])
...
def xdivy(x: _atypes.TensorFuzzingAnnotation[TV_Xdivy_T], y: _atypes.TensorFuzzingAnnotation[TV_Xdivy_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Xdivy_T]:
...
def xdivy_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Xdivy_T], y: _atypes.TensorFuzzingAnnotation[TV_Xdivy_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Xdivy_T]:
...
def xlog1py(x: _atypes.TensorFuzzingAnnotation[TV_Xlog1py_T], y: _atypes.TensorFuzzingAnnotation[TV_Xlog1py_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Xlog1py_T]:
...
def xlog1py_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Xlog1py_T], y: _atypes.TensorFuzzingAnnotation[TV_Xlog1py_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Xlog1py_T]:
  _attr_T, _inputs_T = _execute.args_to_matching_eager([x, y], ctx, [_dtypes.half, _dtypes.bfloat16, _dtypes.float32, _dtypes.float64, _dtypes.complex64, _dtypes.complex128, ])
  (x, y) = _inputs_T
  _inputs_flat = [x, y]
  _attrs = ("T", _attr_T)
...
def xlogy(x: _atypes.TensorFuzzingAnnotation[TV_Xlogy_T], y: _atypes.TensorFuzzingAnnotation[TV_Xlogy_T], name=None) -> _atypes.TensorFuzzingAnnotation[TV_Xlogy_T]:
...
def xlogy_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Xlogy_T], y: _atypes.TensorFuzzingAnnotation[TV_Xlogy_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Xlogy_T]:
  _attr_T, _inputs_T = _execute.args_to_matching_eager([x, y], ctx, [_dtypes.half, _dtypes.bfloat16, _dtypes.float32, _dtypes.float64, _dtypes.complex64, _dtypes.complex128, ])
  (x, y) = _inputs_T
  _inputs_flat = [x, y]
  _attrs = ("T", _attr_T)
...
def zeta_eager_fallback(x: _atypes.TensorFuzzingAnnotation[TV_Zeta_T], q: _atypes.TensorFuzzingAnnotation[TV_Zeta_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Zeta_T]:
