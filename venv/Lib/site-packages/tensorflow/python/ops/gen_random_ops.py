...
def multinomial_eager_fallback(logits: _atypes.TensorFuzzingAnnotation[TV_Multinomial_T], num_samples: _atypes.TensorFuzzingAnnotation[_atypes.Int32], seed: int, seed2: int, output_dtype: TV_Multinomial_output_dtype, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_Multinomial_output_dtype]:
  if seed is None:
    seed = 0
  seed = _execute.make_int(seed, "seed")
  if seed2 is None:
...
def random_gamma_eager_fallback(shape: _atypes.TensorFuzzingAnnotation[TV_RandomGamma_S], alpha: _atypes.TensorFuzzingAnnotation[TV_RandomGamma_T], seed: int, seed2: int, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_RandomGamma_T]:
  if seed is None:
    seed = 0
  seed = _execute.make_int(seed, "seed")
  if seed2 is None:
...
def random_gamma_grad_eager_fallback(alpha: _atypes.TensorFuzzingAnnotation[TV_RandomGammaGrad_T], sample: _atypes.TensorFuzzingAnnotation[TV_RandomGammaGrad_T], name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_RandomGammaGrad_T]:
...
def random_poisson_eager_fallback(shape: _atypes.TensorFuzzingAnnotation[TV_RandomPoisson_S], rate: _atypes.TensorFuzzingAnnotation[TV_RandomPoisson_dtype], seed: int, seed2: int, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_RandomPoisson_dtype]:
  if seed is None:
    seed = 0
  seed = _execute.make_int(seed, "seed")
  if seed2 is None:
...
def random_poisson_v2_eager_fallback(shape: _atypes.TensorFuzzingAnnotation[TV_RandomPoissonV2_S], rate: _atypes.TensorFuzzingAnnotation[TV_RandomPoissonV2_R], seed: int, seed2: int, dtype: TV_RandomPoissonV2_dtype, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_RandomPoissonV2_dtype]:
  if seed is None:
    seed = 0
  seed = _execute.make_int(seed, "seed")
  if seed2 is None:
...
TV_RandomShuffle_T = TypeVar("TV_RandomShuffle_T", _atypes.BFloat16, _atypes.Bool, _atypes.Complex128, _atypes.Complex64, _atypes.Float16, _atypes.Float32, _atypes.Float64, _atypes.Half, _atypes.Int16, _atypes.Int32, _atypes.Int64, _atypes.Int8, _atypes.QInt16, _atypes.QInt32, _atypes.QInt8, _atypes.QUInt16, _atypes.QUInt8, _atypes.Resource, _atypes.String, _atypes.UInt16, _atypes.UInt32, _atypes.UInt64, _atypes.UInt8, _atypes.Variant)

def random_shuffle(value: _atypes.TensorFuzzingAnnotation[TV_RandomShuffle_T], seed:int=0, seed2:int=0, name=None) -> _atypes.TensorFuzzingAnnotation[TV_RandomShuffle_T]:
...
def random_shuffle_eager_fallback(value: _atypes.TensorFuzzingAnnotation[TV_RandomShuffle_T], seed: int, seed2: int, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_RandomShuffle_T]:
  if seed is None:
    seed = 0
  seed = _execute.make_int(seed, "seed")
  if seed2 is None:
...
def random_standard_normal_eager_fallback(shape: _atypes.TensorFuzzingAnnotation[TV_RandomStandardNormal_T], dtype: TV_RandomStandardNormal_dtype, seed: int, seed2: int, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_RandomStandardNormal_dtype]:
  dtype = _execute.make_type(dtype, "dtype")
  if seed is None:
    seed = 0
  seed = _execute.make_int(seed, "seed")
...
def random_uniform(shape: _atypes.TensorFuzzingAnnotation[TV_RandomUniform_T], dtype: TV_RandomUniform_dtype, seed:int=0, seed2:int=0, name=None) -> _atypes.TensorFuzzingAnnotation[TV_RandomUniform_dtype]:
...
def random_uniform_eager_fallback(shape: _atypes.TensorFuzzingAnnotation[TV_RandomUniform_T], dtype: TV_RandomUniform_dtype, seed: int, seed2: int, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_RandomUniform_dtype]:
  dtype = _execute.make_type(dtype, "dtype")
  if seed is None:
    seed = 0
  seed = _execute.make_int(seed, "seed")
...
def random_uniform_int_eager_fallback(shape: _atypes.TensorFuzzingAnnotation[TV_RandomUniformInt_T], minval: _atypes.TensorFuzzingAnnotation[TV_RandomUniformInt_Tout], maxval: _atypes.TensorFuzzingAnnotation[TV_RandomUniformInt_Tout], seed: int, seed2: int, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_RandomUniformInt_Tout]:
  if seed is None:
    seed = 0
  seed = _execute.make_int(seed, "seed")
  if seed2 is None:
...
def truncated_normal(shape: _atypes.TensorFuzzingAnnotation[TV_TruncatedNormal_T], dtype: TV_TruncatedNormal_dtype, seed:int=0, seed2:int=0, name=None) -> _atypes.TensorFuzzingAnnotation[TV_TruncatedNormal_dtype]:
...
def truncated_normal_eager_fallback(shape: _atypes.TensorFuzzingAnnotation[TV_TruncatedNormal_T], dtype: TV_TruncatedNormal_dtype, seed: int, seed2: int, name, ctx) -> _atypes.TensorFuzzingAnnotation[TV_TruncatedNormal_dtype]:
  dtype = _execute.make_type(dtype, "dtype")
  if seed is None:
    seed = 0
  seed = _execute.make_int(seed, "seed")
