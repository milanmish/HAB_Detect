...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.imgLbl = customtkinter.CTkLabel(self.sidebar_frame, text = "", font=customtkinter.CTkFont(size=12, weight="normal"))
        self.imgLbl.grid(row = 2, column=0, padx=20, pady=5)

        def imgCheckClicked():
            self.imgLbl.configure(text="Analyzing...")
            #import HAB_Detect
